    ...
    <?php include('partials-front/menu.php'); //session_start(); error_reporting(0); ?>
    ...
    <?php 
    if(isset($_SESSION['j4']))echo $_SESSION['j4']; echo '<br>';
    if(isset($_SESSION['j5']))echo $_SESSION['j5']; echo '<br>';
    if(isset($_SESSION['j9']))echo $_SESSION['j9'];
    ?>
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <div class="food-menu-box">
                            ...
                            <div class="food-menu-desc">
                                ...
                                <a href="<?php echo SITEURL; ?>zamow<?php echo $id; ?>.php" class="btn btn-primary">Zamów Teraz</a>
                            </div>
                        </div>
